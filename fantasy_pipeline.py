...
def fetch_complete_fantasy_state(oauth_file='oauth2.json'):
    ...
    Returns (rosters_df, league_metadata_dict)
    """
    ...
    for team_idx in range(teams_data['count']):
        ...
        # Pull dynamic settings and waiver player buffers
...
if __name__ == "__main__":
    ...
    print("\nDynamic League Meta:", json.dumps(meta, indent=2))
